...
@pytest.fixture
def params():
    return Params(verbose=True, render_tree=False, ai=False, output='console')
...
def input_record(tmp_path):
    return InputRecord(name='test', dir='.', record_base=tmp_path, filepaths=[], driver='ipynb', default_atype='requirement', marker='REQ')
